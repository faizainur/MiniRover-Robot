      ...
      0000DF                        346 _DELAY_us:
                           ...
                           000001   353 	ar1 = 0x01
                           000000   354 	ar0 = 0x00
      0000DF AE 82            [24]  355 	mov	r6,dpl
      0000E1 AF 83            [24]  356 	mov	r7,dph
                                    357 ;	src/libs/delay.c:51: while(us_count!=0)
      0000E3                        358 00101$:
      0000E3 EE               [12]  359 	mov	a,r6
      0000E4 4F               [12]  360 	orl	a,r7
      0000E5 60 07            [24]  361 	jz	00104$
                                    362 ;	src/libs/delay.c:53: us_count--;
      0000E7 1E               [12]  363 	dec	r6
      0000E8 BE FF 01         [24]  364 	cjne	r6,#0xff,00116$
      0000EB 1F               [12]  365 	dec	r7
      0000EC                        366 00116$:
      0000EC 80 F5            [24]  367 	sjmp	00101$
      0000EE                        368 00104$:
                                    369 ;	src/libs/delay.c:55: }
      0000EE 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    379 ;	-----------------------------------------
      0000EF                        380 _DELAY_ms:
      0000EF AE 82            [24]  381 	mov	r6,dpl
      0000F1 AF 83            [24]  382 	mov	r7,dph
                                    383 ;	src/libs/delay.c:72: while(ms_count!=0)
      0000F3                        384 00101$:
      0000F3 EE               [12]  385 	mov	a,r6
      0000F4 4F               [12]  386 	orl	a,r7
      0000F5 60 15            [24]  387 	jz	00104$
                                    388 ;	src/libs/delay.c:74: DELAY_us(C_CountForOneMsDelay_U16);     //DELAY_us is called to generate 1ms delay
      0000F7 90 00 70         [24]  389 	mov	dptr,#0x0070
      0000FA C0 07            [24]  390 	push	ar7
      0000FC C0 06            [24]  391 	push	ar6
      0000FE 12 00 DF         [24]  392 	lcall	_DELAY_us
      000101 D0 06            [24]  393 	pop	ar6
      000103 D0 07            [24]  394 	pop	ar7
                                    395 ;	src/libs/delay.c:75: ms_count--;
      000105 1E               [12]  396 	dec	r6
      000106 BE FF 01         [24]  397 	cjne	r6,#0xff,00116$
      000109 1F               [12]  398 	dec	r7
      00010A                        399 00116$:
      00010A 80 E7            [24]  400 	sjmp	00101$
      00010C                        401 00104$:
                                    402 ;	src/libs/delay.c:78: }
      00010C 22               [24]  403 	ret
                                    404 	.area CSEG    (CODE)
                                    405 	.area CONST   (CODE)
                                    406 	.area XINIT   (CODE)
